...
public class ExecutionPlanSubscriber extends StreamFunctionProcessor {
    ...
    private static final Logger LOGGER = Logger.getLogger(ExecutionPlanSubscriber.class);
    ...
    void upCount() {
        ...
        LOGGER.info("upCountNumberOfExecutionPlans current count after update = " + ExecutionPlansCount
                .getNumberOfExecutionPlans());
    }

    void downCount() {
        ExecutionPlansCount.downCount();
        LOGGER.info("downCountNumberOfExecutionPlans current count after update = " + ExecutionPlansCount
                .getNumberOfExecutionPlans());
    }
