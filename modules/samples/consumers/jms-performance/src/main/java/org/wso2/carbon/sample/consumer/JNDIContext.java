...
public class JNDIContext {
    private static Logger log = Logger.getLogger(JNDIContext.class);
...
//        create topic connection factory
        try {
            ...
            log.info("Can not create topic connection factory." + e);
        }
    }
    ...
    private void createInitialContext() {
        ...
        try {
            ...
            log.info("Can not create initial context with given parameters." + e);
        }
    }
}