...
public class PizzaPublisherClient {
    ...
    public static void main(String[] args)
        ...
        AgentHolder.setConfigPath(getAgentConfigPath());
        String host = args[0];
        String port = args[1];
        ...
        String streamId1 = DataBridgeCommonsUtils.generateStreamId("orderStream", "1.0.0");
//        try {
...
//        }
        ...
        String streamId = DataBridgeCommonsUtils.generateStreamId("deliveryStream", "1.0.0");
//        try {
