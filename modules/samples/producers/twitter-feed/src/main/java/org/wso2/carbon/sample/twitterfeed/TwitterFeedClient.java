...
public class TwitterFeedClient {
    ...
    public static void main(String[] args)
        ...
        for (int i = 0; i < MAX_ITERATIONS; i++) {
            ...
            dataPublisher.publish(streamId, null, null, new Object[]{"FB", 8});
            System.out.println("TwitterFeed Message " + (i + 1) + " sent");
            Thread.sleep(3000);

            dataPublisher.publish(streamId, null, null, new Object[]{"FB", 6});
            ...
            dataPublisher.publish(streamId, null, null, new Object[]{"FB", 12});
            System.out.println("TwitterFeed Message " + (i + 4) + " sent");
            Thread.sleep(2000);

            dataPublisher.publish(streamId, null, null, new Object[]{"LNKD", 6});
            System.out.println("TwitterFeed Message " + (i + 5) + " sent");
            Thread.sleep(2000);

            dataPublisher.publish(streamId, null, null, new Object[]{"LNKD", 2});
