...
public class FusionLocalBrokerCustomEventClient {
    ...
    private void subscribe() {
        ...
        try {
            this.subscriptionID = this.brokerClient.subscribe("CustomEventConditionSatisfyingStockQuotes", "http://127.0.0.1:9763/services/FastMovingStockQuoteService/getOMElement");
    ...
    public static void main(String[] args) {
        ...
        FusionLocalBrokerCustomEventClient messageBoxSubClient = new FusionLocalBrokerCustomEventClient();
    ...
    public void publishMessages() {
        ...
        try {
            ...
            serviceClient.setTargetEPR(new EndpointReference("http://localhost:9763/services/localBrokerService/CustomEventStockQuotes"));
        } catch (AxisFault axisFault) {
            axisFault.printStackTrace();
        }
