...
public class FusionLocalBrokerClient {
    ...
    private void subscribe() {
        ...
        try {
            this.subscriptionID = this.brokerClient.subscribe("ConditionSatisfyingStockQuotes", "http://127.0.0.1:9763/services/FastMovingStockQuoteService/getOMElement");
    ...
    public static void main(String[] args) {
        ...
        FusionLocalBrokerClient messageBoxSubClient = new FusionLocalBrokerClient();
