...
import org.wso2.carbon.integration.test.ui.CEPIntegrationUiTestCase;
...
public class JSPSamplesTestCase extends CEPIntegrationUiTestCase {
    ...
    @Test(groups = "wso2.cep", description = "Verify example: Expression Language - Composite Expressions")
    ...
    @Test(groups = "wso2.cep", description = "Verify example: SimpleTag Handlers and JSP Fragments - Book example")
    ...
    @Test(groups = "wso2.cep", description = "Verify example: Tag Files - Display Products Example")
    ...
    @Test(groups = "wso2.cep", description = "Verify example: New JSP XML Syntax (.jspx) - XHTML Basic Example")
