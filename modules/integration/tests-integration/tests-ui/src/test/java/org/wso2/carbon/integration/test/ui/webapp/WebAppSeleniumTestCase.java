...
public class WebAppSeleniumTestCase extends CEPIntegrationUiTestCase {
    ...
    @Test(groups = "wso2.cep", description = "Verify example:servlet HelloWorldExample")
    public void testHelloWorldExample() throws Exception {
        driver.get(cepServer.getWebAppURL() + "/example/servlets/");
    ...
    @Test(groups = "wso2.cep", description = "Verify example:servlet RequestInfoExample")
