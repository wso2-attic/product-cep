...
public class CEPIntegrationUiTestCase {
    private static final Log log = LogFactory.getLog(CEPIntegrationUiTestCase.class);
    ...
    protected boolean isRunningOnCloud() {
        return FrameworkFactory.getFrameworkProperties(ProductConstant.CEP_SERVER_NAME).getEnvironmentSettings().is_runningOnStratos();
