...
public class Wso2EventClient {
    ...
    private static Logger log = Logger.getLogger(Wso2EventClient.class);
    ...
    public static String getTestDataFileLocation(String testCaseFolderName, String dataFimeName) {
