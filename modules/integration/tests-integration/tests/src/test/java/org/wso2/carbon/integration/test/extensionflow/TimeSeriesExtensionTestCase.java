...
public class TimeSeriesExtensionTestCase extends CEPIntegrationTest {
	...
	@Test(groups = {
			"wso2.cep" }, description = "Testing Time Series Linear Regression Siddhi Extension") public void siddhiTimeSeriesExtensionTestScenario()
			throws Exception {
		...
		Wso2EventServer agentServer = new Wso2EventServer("extensionflows/timeseries", 7661, true);
