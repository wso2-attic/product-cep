...
public class JMSMapMessageTestCase extends CEPIntegrationTest {
    ...
    protected void init() throws LoginAuthenticationExceptionException, RemoteException {
        super.init();
        ...
        eventBuilderAdminServiceClient = configurationUtil.getEventBuilderAdminServiceClient(userInfo, cepServer, loggedInSessionCookie);
        eventFormatterAdminServiceClient = configurationUtil.getEventFormatterAdminServiceClient(userInfo, cepServer, loggedInSessionCookie);
        eventProcessorAdminServiceClient = configurationUtil.getEventProcessorAdminServiceClient(userInfo, cepServer, loggedInSessionCookie);
        inputEventAdaptorManagerAdminServiceClient = configurationUtil.getInputEventAdaptorManagerAdminServiceClient(userInfo, cepServer, loggedInSessionCookie);
        outputEventAdaptorManagerAdminServiceClient = configurationUtil.getOutputEventAdaptorManagerAdminServiceClient(userInfo, cepServer, loggedInSessionCookie);
        eventStreamManagerAdminServiceClient = configurationUtil.getEventStreamManagerAdminServiceClient(userInfo, cepServer, loggedInSessionCookie);
    ...
    public void testJMSMapMessage() throws Exception {
        ...
        String eventBuilderConfig = getArtifactConfigurationFromClasspath("/artifacts/CEP/ebconfigs/AccessLogs.xml");
